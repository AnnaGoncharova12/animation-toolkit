...
int main(int argc, char** argv)
{
   ...
   /*
   //find id of the left hand
   for(int i=0;i<skeleton.getNumJoints();i++){
           std::cout << skeleton.getByID(i)->getName() << "has id "<<i << std::endl;
   ...
   */
   ...
   //std::vector<glm::quat> jointRots=frame5.jointRots;
   vec3 eulerXYZ =extractEulerAngleRO(XYZ, glm::toMat3(hand->getLocalRotation()) );
